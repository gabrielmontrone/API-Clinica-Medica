...
from historicos.api.viewset import HistoricosViewSet
from imagens.api.viewsets import ImagensHistoricoViewSet, ImagensPacienteViewSet
...
router.register(r'imagens_pacientes', ImagensPacienteViewSet)
